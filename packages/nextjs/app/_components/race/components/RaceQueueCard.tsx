              ...
              return (
                <div
                  ...
                  className={`relative rounded-xl border border-base-300 bg-base-200/40 p-2 ${
                    isUserRaffe ? "ring-2 ring-primary ring-offset-2 ring-offset-base-100" : ""
                  }`}
                >
                  ...
                  {isUserRaffe ? <div className="absolute top-1 right-1 badge badge-primary badge-sm">You</div> : null}
                </div>
              );
            })}
          </div>
