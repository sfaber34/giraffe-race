...
## What it is
Basic test of how to do a deterministic animal race game using deterministic dice. Many limitations (betting payout scheme, using eth for bets, a draw picks a winner at random between the draw animals, I'm sure other stuff) but a basic test so far.
